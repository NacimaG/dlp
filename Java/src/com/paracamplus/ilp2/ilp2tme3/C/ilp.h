...
#define ILP_AllocateVector(s) \
  ILP_malloc((s+1)*sizeof(struct ILP_Object), &ILP_object_Vector_class)
...
extern ILP_Object ILP_sinus(ILP_Object d);
extern ILP_Object ILP_vectorLength(ILP_Object v);
extern ILP_Object ILP_vectorGet(ILP_Object v,ILP_Object ind);
extern ILP_Object ILP_makeVector(ILP_Object v,ILP_Object t);
