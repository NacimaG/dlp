...
ILP_Object ilp__color1_4(ILP_Closure ilp_useless,
    ILP_Object self3) {
...
ILP_Object ilp__color2_6(ILP_Closure ilp_useless,
    ILP_Object self5) {
...
ilptmp744 = pl8; 
ilptmp743 = ILP_find_method(ilptmp744, &ILP_object_color1_method, 1);
