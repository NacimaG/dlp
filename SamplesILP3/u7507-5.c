...
/* Global prototypes */
ILP_Object ilp__mkf (ILP_Closure ilp_useless, ILP_Object y1, ILP_Object z2);
ILP_Object ilpclosure4 (ILP_Closure ilp_closure, ILP_Object t3);

/* Global functions */

ILP_Object
ilp__mkf (ILP_Closure ilp_useless, ILP_Object y1, ILP_Object z2)
{
  y1 = ILP_Value2Box (y1);
  z2 = ILP_Value2Box (z2);
