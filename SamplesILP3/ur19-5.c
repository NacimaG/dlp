...
/* Global prototypes */
ILP_Object quadruple1_23 (ILP_Closure ilp_closure, ILP_Object n3);
ILP_Object double2_24 (ILP_Closure ilp_closure, ILP_Object x4);

/* Global functions */
ILP_Object
quadruple1_23 (ILP_Closure ilp_closure, ILP_Object n3)
{
...
ILP_Object
double2_24 (ILP_Closure ilp_closure, ILP_Object x4)
{
  {
...
{
  {
	...
	ILP_SetBoxedValue (quadruple1,
			   ILP_make_closure (quadruple1_23, 1, 1, double2));
